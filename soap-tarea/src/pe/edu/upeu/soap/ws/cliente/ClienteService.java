...
public class ClienteService {
	public static void main(String[] args) {
		...
		System.out.println("Producto " + pd.readVenta("2021-05-04", "2021-05-10", 1).getNomprod());
		System.out.println("Documento " + pd.readVenta("2021-05-04", "2021-05-10", 1).getTipodoc());
		System.out.println("Número " + pd.readVenta("2021-05-04", "2021-05-10", 1).getNumdoc());
		...
		System.out.println("Subtotal " + pd.readVenta("2021-05-04", "2021-05-10", 1).getPrecia());
	}
}
